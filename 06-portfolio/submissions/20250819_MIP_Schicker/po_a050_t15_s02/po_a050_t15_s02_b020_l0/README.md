# Submission for po_a050_t15_s02_b020_l0

This directory contains the submission for the problem **po_a050_t15_s02_b020_l0**.

| Field | Value 1 |
| --- | --- |
| Problem | po_a050_t15_s02_b020_l0 |
| Submitter | Maximilian Schicker |
| Affiliation | Zuse Institute Berlin |
| Date | 2025-08-20 |
| ====== |  |
| Reference | See Models Directory using Gurobi 12.0.1 |
| Best Objective Value | -885463.0 |
| Optimality Bound | -885463.0 |
| ====== |  |
