# Submission for po_a010_t15_orig_b004_l1e-4

This directory contains the submission for the problem **po_a010_t15_orig_b004_l1e-4**.

| Field | Value 1 |
| --- | --- |
| Problem | po_a010_t15_orig_b004_l1e-4 |
