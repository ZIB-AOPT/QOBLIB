# Submission for po_a010_t15_orig_b004_l1e-3

This directory contains the submission for the problem **po_a010_t15_orig_b004_l1e-3**.

| Field | Value 1 |
| --- | --- |
| Problem | po_a010_t15_orig_b004_l1e-3 |
