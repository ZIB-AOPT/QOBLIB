# Submission for a010_t10_s00_b004_l0

This directory contains the submission for the problem **a010_t10_s00_b004_l0**.

| Field | Value 1 |
| --- | --- |
| Problem | a010_t10_s00_b004_l0 |
| Submitter | Manan Gupta |
| Affiliation | The Harker School |
| Date | 2026-08-18 |
| ====== |  |
| Reference | https://github.com/mnn31/qoblib-solvers/tree/main/portfolio |
| Best Objective Value | -231120 |
| Optimality Bound | -231120 |
| ====== |  |
...
| # Non-Zero Coefficients | 2790 |
| Coefficients Type | Integer |
| Coefficients Range | -28872 - 149 |
| ====== |  |
...
| ====== |  |
| Total Runtime | 143.938 |
| Time to Solution | 143.938 |
| CPU Runtime | 143.938 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
