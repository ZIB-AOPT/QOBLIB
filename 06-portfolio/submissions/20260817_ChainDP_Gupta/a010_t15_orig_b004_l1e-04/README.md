# Submission for a010_t15_orig_b004_l1e-04

This directory contains the submission for the problem **a010_t15_orig_b004_l1e-04**.

| Field | Value 1 |
| --- | --- |
| Problem | a010_t15_orig_b004_l1e-04 |
...
| # Non-Zero Coefficients | 57999 |
| Coefficients Type | Integer |
| Coefficients Range | -5444 - 1630 |
| ====== |  |
...
| ====== |  |
| Total Runtime | 277.026 |
| Time to Solution | 277.026 |
| CPU Runtime | 277.026 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
