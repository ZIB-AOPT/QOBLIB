# Submission for a010_t15_orig_b004_l0

This directory contains the submission for the problem **a010_t15_orig_b004_l0**.

| Field | Value 1 |
| --- | --- |
| Problem | a010_t15_orig_b004_l0 |
| Submitter | Manan Gupta |
| Affiliation | The Harker School |
| Date | 2026-08-18 |
| ====== |  |
| Reference | https://github.com/mnn31/qoblib-solvers/tree/main/portfolio |
| Best Objective Value | -173822 |
| Optimality Bound | -173822 |
| ====== |  |
...
| ====== |  |
| Total Runtime | 226.794 |
| Time to Solution | 226.794 |
| CPU Runtime | 226.794 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
