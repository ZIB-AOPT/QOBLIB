...
| Date | 2026-08-05 |
| ====== |  |
| Reference | This submission builds on the ISQR post-processing routine introduced in [I. de León et al., arXiv:2512.22001 (2025)](https://arxiv.org/abs/2512.22001) and applies it to a random sample. ISQR adapts the SQD method to QUBO problems; its extension to the QOBLIB formulation is straightforward. The QUBO follows the model in `06-portfolio/info/model_setting.pdf`, with risk factor λ = 2e-05 and constraint penalty P = 1.0. Full ISQR hyperparameters and the variable mapping are documented in the submission-root README ([../README.md](../README.md)). |
