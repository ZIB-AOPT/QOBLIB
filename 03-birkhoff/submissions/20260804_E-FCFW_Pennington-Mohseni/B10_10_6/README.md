...
| # Decision Variables | 376 |
| # Binary Variables | 238 |
| # Integer Variables | N/A |
| # Continuous Variables | 138 |
| # Non-Zero Coefficients | 276 |
...
| ====== |  |
| Hardware Specifications | IBM_Miami; MacBook Pro (16-inch, 2021) Apple M1 Max 10-core CPU, 32-core GPU, 64GB RAM |
| ====== |  |
| Total Runtime | 3267.26 |
| Time to Solution | 1949 |
| CPU Runtime | 1025 |
| GPU Runtime | N/A |
| QPU Runtime | 924 |
