...
| ====== |  |
| Remarks | Independent set sizes over seeds [42, 43, 44, 45, 46]: [12, 12, 12, 12, 12] (proven optimum 12). Feasibility guaranteed by deterministic repair postprocessing. Quantum-inspired constraint-preserving swap SA. |
