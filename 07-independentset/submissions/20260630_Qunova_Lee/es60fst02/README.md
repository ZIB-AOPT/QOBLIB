...
| ====== |  |
| Hardware Specifications | IBM ibm_fez QPU; Intel Core i9-14900K (24 cores / 32 threads; max 6.0 GHz); no GPU |
| ====== |  |
| Total Runtime | 869.40 |
| CPU Runtime | 98.31 |
| GPU Runtime | 0 |
| QPU Runtime | 771.09 |
| Other HW Runtime | 0 |
| ====== |  |
| Remarks | Ansatz: H init; Heisenberg entanglement (RZZ+RXX+RYY) full connectivity; Ry variational rotation; approximation ratio=0.9545 (84/88) |
