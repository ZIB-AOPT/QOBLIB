...
| ====== |  |
| Total Runtime | 516.32 |
| CPU Runtime | 60.32 |
| GPU Runtime | 0 |
| QPU Runtime | 456.00 |
| Other HW Runtime | 0 |
| ====== |  |
| Remarks | Ansatz: H init; Heisenberg entanglement (RZZ+RXX+RYY) full connectivity; Ry variational rotation; approximation ratio=1.0000 (55/55) |
