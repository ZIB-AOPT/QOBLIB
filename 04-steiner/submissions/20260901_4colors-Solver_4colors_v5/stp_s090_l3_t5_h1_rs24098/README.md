# Submission for stp_s090_l3_t5_h1_rs24098

This directory contains the submission for the problem **stp_s090_l3_t5_h1_rs24098**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s090_l3_t5_h1_rs24098 |
...
| Total Runtime | 206.820 |
| Time to Solution | N/A |
| CPU Runtime | 206.820 |
| GPU Runtime | 0 |
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=11 terminals=40; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
