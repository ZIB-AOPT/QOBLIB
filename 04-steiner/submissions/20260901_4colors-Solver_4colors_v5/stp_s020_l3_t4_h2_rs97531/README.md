# Submission for stp_s020_l3_t4_h2_rs97531

This directory contains the submission for the problem **stp_s020_l3_t4_h2_rs97531**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s020_l3_t4_h2_rs97531 |
...
| Total Runtime | 181.307 |
| Time to Solution | N/A |
| CPU Runtime | 181.307 |
| GPU Runtime | 0 |
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=8 terminals=26; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
