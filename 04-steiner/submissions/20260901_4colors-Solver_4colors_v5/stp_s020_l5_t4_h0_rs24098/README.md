# Submission for stp_s020_l5_t4_h0_rs24098

This directory contains the submission for the problem **stp_s020_l5_t4_h0_rs24098**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s020_l5_t4_h0_rs24098 |
...
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=8 terminals=28; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
