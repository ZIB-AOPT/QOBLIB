# Submission for stp_s020_l4_t4_h3_rs37235

This directory contains the submission for the problem **stp_s020_l4_t4_h3_rs37235**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s020_l4_t4_h3_rs37235 |
...
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=8 terminals=22; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
