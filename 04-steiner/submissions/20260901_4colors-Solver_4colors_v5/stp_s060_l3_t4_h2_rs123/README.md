# Submission for stp_s060_l3_t4_h2_rs123

This directory contains the submission for the problem **stp_s060_l3_t4_h2_rs123**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s060_l3_t4_h2_rs123 |
...
| Total Runtime | 189.584 |
| Time to Solution | N/A |
| CPU Runtime | 189.584 |
| GPU Runtime | 0 |
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=13 terminals=39; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
