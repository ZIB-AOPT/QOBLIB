# Submission for stp_s030_l3_t3_h2_rs97531

This directory contains the submission for the problem **stp_s030_l3_t3_h2_rs97531**.

## CSV Summary

| Field | Value |
|-------|-------|
| Problem | stp_s030_l3_t3_h2_rs97531 |
...
| QPU Runtime | 0 |
| Other HW Runtime | 0 |
| Remarks | nets=11 terminals=26; objective is edge count (all weights unit). Classical result: there is no quantum contribution to any objective value in this submission. No QPU, GPU, annealer or quantum simulator was used at any point; QPU runtime is 0 because there was no QPU in the loop. |
