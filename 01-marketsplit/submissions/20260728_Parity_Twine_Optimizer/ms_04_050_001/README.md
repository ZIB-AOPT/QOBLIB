...
| ====== |  |
| Total Runtime | 313.603 |
| Time to Solution | 313.603 |
| CPU Runtime | 284.603 |
| GPU Runtime | N/A |
| QPU Runtime | 29.0 |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | The Best Objective Value is the market split violation. Statistics for the Objective value across the runs: min: 1.0, median: 1.0, mean: 1.0, max: 1.0, std: 0.0.  |
