...
| # Non-Zero Coefficients | 821 |
| Coefficients Type | Integer |
| Coefficients Range | -786402.0 - 61874.0 |
| ====== |  |
...
| ====== |  |
| Total Runtime | 4258.1364 |
| Time to Solution | 4258.1364 |
| CPU Runtime | 599.793 |
| GPU Runtime | N/A |
| QPU Runtime | 30.0 |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | The Best Objective Value is the market split violation. Statistics for the Objective value across the runs: min: 3.0, median: 10.0, mean: 9.6, max: 15.0, std: 3.8781438859330635.  |
