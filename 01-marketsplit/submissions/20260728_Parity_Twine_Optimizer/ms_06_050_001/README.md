...
| # Non-Zero Coefficients | 1276 |
| Coefficients Type | Integer |
| Coefficients Range | -286422.0 - 16296.0 |
| ====== |  |
...
| ====== |  |
| Total Runtime | 992.9144 |
| Time to Solution | 992.9144 |
| CPU Runtime | 962.9144 |
| GPU Runtime | N/A |
| QPU Runtime | 30.0 |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | The Best Objective Value is the market split violation. Statistics for the Objective value across the runs: min: 4.0, median: 14.0, mean: 12.6, max: 19.0, std: 5.2.  |
