...
| Other HW Runtime | 0 |
| ====== |  |
| Remarks | Single run of a stochastic graph-based genetic algorithm. Known optimal = 669; gap = 2.84%. Time to Solution is the timestamp of the last logged incumbent improvement in that run. |
