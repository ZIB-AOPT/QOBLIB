...
| Other HW Runtime | 0 |
| ====== |  |
| Remarks | Single run of a stochastic graph-based genetic algorithm. Known optimal = 830; gap = 0.12%. Time to Solution is the timestamp of the last logged incumbent improvement in that run. |
